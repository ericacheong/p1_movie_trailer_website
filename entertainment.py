...
fight_club = media.Movie("Fight Club",
                         ...
                         soap maker and they form an underground fight club \
...
inception = media.Movie("Inception",
                        "A story about a thief stealing secret by \
...
dark_knight = media.Movie("The Dark Knight",
                          "Batman faces the manic, the Joker who wreaks \
                          havoc and chaos on the people of Gotham. He \
                          has to face the fear of his ability to fight\
                          justice.",
...
memento = media.Movie("Memento",
                      ...
                      remember things; so he can hunt for the murderer \
                      of his wife without his short-term memory loss \
                      being an obstacle.",
...
dogville = media.Movie("Dogville",
                        ...
                        accepted in a small Colorado town. In exchange, she \
                        agrees to work for them. As a search visits town, she \
                        finds out that their support has a price.",
                        "https://upload.wikimedia.org/wikipedia/en/1/10/Dogville_poster.jpg",
                        "https://www.youtube.com/watch?v=XFocbsVe_Ao",
                        2003)


movies = [avengers, fight_club, inception,
          dark_knight, matrix, memento,
          seven, dogville]
...
fresh_tomatoes.open_movies_page(sorted(s, key=attrgetter('year'),
                                       reverse=True))
